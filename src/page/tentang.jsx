  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 pt-16">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white shadow-md p-4 z-50">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="space-x-6">
            <Link to="/tentang" className="text-gray-900 font-bold ">Tentang</Link>
      ...
      <div className="container mx-auto px-4 py-20 text-center">
        <h1 class="bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text text-5xl font-bold pb-5">Tentang Digipustaka</h1>
